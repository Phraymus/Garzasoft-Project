                ...
                <li class="nav-item">
                    ...
                    <div id="proyecton1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-navbar-lateral py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item " href="${pageContext.request.contextPath}/dashboard-administar/administar.html">Administrar</a>
                            <a class="collapse-item " href="${pageContext.request.contextPath}/dashboard-administar/calendario.html">Calendario</a>
