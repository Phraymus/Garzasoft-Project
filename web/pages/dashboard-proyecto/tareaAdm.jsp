            ...
            <div id="content">
                ...
                <div class="container-lg">
                    <div id="container" class="align-items-lg-center">
                        ...
                        <form action="${pageContext.request.contextPath}/ProyectoController?btnEnviar=doUpdate&idProyecto=${infoProyecto.getIdtb_proyecto()}" method="post">
                        <table class="row justify-content-md-center">
                            <tr>
                                ...
                                <td>
                                    <input name="txtTarea" class="mt-3 ml-3 text-dark form-control" value="${infoProyecto.getTarea()}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <h5 class="mt-3 ml-3 text-dark"><textarea name="txtDescripcion" class="form-control" id="floatingTextarea2"
                                                                              style="height: 150px">${infoProyecto.getTarea_descripcion()}</textarea></h5>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    onChange="informacion_modal2(
                                                            ...
                                                            '${pageContext.request.contextPath}/ProyectoController?btnEnviar=doUpdateEstadoProyecto&idProyecto=${infoProyecto.getIdtb_proyecto()}&llamado=adm',
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="txtFechaInicio" type="date" class="mt-3 ml-3 text-dark form-control" value="<fmt:formatDate value = "${infoProyecto.getFecha_inicio()}" pattern = "yyyy-MM-dd"/>">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input name="txtFechaFin" type="date" class="mt-3 ml-3 text-dark form-control" value="<fmt:formatDate value = "${infoProyecto.getFecha_fin()}" pattern = "yyyy-MM-dd"/>">
                                </td>
                            </tr>
                            <tr class="mt-5" colspan="3">
                                <td class=" text-center align-items-lg-center" colspan="3">
                                    <button type="submit" id="" class="mt-3 btn btn-success">Enviar</button>
                                </td>
                            </tr>
                        </table>
                        </form>
