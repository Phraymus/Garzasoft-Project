...
<html lang="es">
    ...
    <body>
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#table-usuarios-clientes').DataTable();
            });

            function editUser(idPersonaEdit, id, nombre, nombres, apellido_paterno, apellido_materno, correo, tipo_identificacion, numero_identificacion, telefono, idPais, idDepartamento, nombreDepartamento, idCiudad, nombreCiudad, src, nombreEmpresa, ruc) {
                $('#editUser').modal('show');
                ...
                if(nombreEmpresa!=""){
                    document.getElementById("cmbTipoEdit").value="Juridica";
                }
            }
            ...
            function tipoCliente() {
                if (document.getElementById("cmbTipoEdit").value == "Natural") {
                    document.getElementById("JuEdit").className = "d-none";
                    document.getElementById("Ju1Edit").className = "d-none";
                } else {
                    document.getElementById("JuEdit").className = "";
                    document.getElementById("Ju1Edit").className = "";
                }

                if (document.getElementById("cmbTipoAdd").value == "Natural") {
                    document.getElementById("JuAdd").className = "d-none";
                    document.getElementById("Ju1Add").className = "d-none";
                } else {
                    document.getElementById("JuAdd").className = "";
                    document.getElementById("Ju1Add").className = "";
                }
            }
        </script>
            ...
            <div class="d-md-flex align-items-start justify-content-between mb-4">
                <div class="table-responsive w-100 p-3">
                    ...
                    <table id="example" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            <c:forEach var="user" items="${lstClientes}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        href="javascript:editUser(
                                           ...
                                           '${pageContext.request.contextPath}/PersonaController?btnEnviar=getImage&id=${user.getPersona().getIdtb_persona()}',
                                           '${user.getCliente().getNombreEmpresa()}',
                                           '${user.getCliente().getRuc()}')"><i class="fas fa-pen"></i></a>
                                    ...
                                    <td>
                                        <input type="button" class="btn btn-success" onclick="seleccionarCliente('${user.getPersona().getIdtb_persona()}','${user.getPersona().getNombre()}','${user.getPersona().getApellido_paterno()}','${user.getPersona().getApellido_materno()}')" value="Seleccionar">
                                    </td>
                                    <%}%>
                                </tr>
                            </c:forEach>
        ...
        <div id="addUser" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="${pageContext.request.contextPath}/UsuarioController?btnEnviar=putUserCliente" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="mt-3">Tipo cliente</h5>
                                    </td>
                                    <td>
                                        <h5 class="mt-3">:</h5>
                                    </td>
                                    <td>
                                        <select id="cmbTipoAdd" name="txtTipoPersona" onchange="javascript:tipoCliente()" class=" ml-1 mt-3 form-control">
                                ...
                                <tr id="JuAdd" class="d-none">
                                    ...
                                    <td>
                                        <input name="txtNombreEmpresa" class="form-control ml-1 mt-3 text-dark " type="text ">
                                    </td>
                                </tr>

                                <tr id="Ju1Add"  class="d-none">
                                    <td>
                                    ...
                                    <td>
                                        <input name="txtRuc" class="form-control ml-1 mt-3 text-dark " type="text " value="" minlength="11" maxlength="11 " pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]">
                                    </td>
                                </tr>
        ...
        <div id="editUser" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Editar usuario cliente</h4>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>

                    <form action="${pageContext.request.contextPath}/UsuarioController?btnEnviar=setUserCliente" method="post" enctype="multipart/form-data">
                        ...
                        <table>
                            <tr class="d-none">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="cmbTipoEdit" name="txtTipoPersona" onchange="javascript:tipoCliente()" class=" ml-1 mt-3 form-control">
                                            <option value="Natural">
                                                Natural
                                            </option>
                                            <option value="Juridica">
                                ...
                                <tr id="JuEdit"  class="d-none">
                                    ...
                                    <td>
                                        <input id="nombreEmpresa" name="txtNombreEmpresa" class="form-control ml-1 mt-3 text-dark " type="text ">
                                    </td>
                                </tr>

                                <tr id="Ju1Edit" class="d-none">
                                    <td>
                                        <h5 class="mt-3 ">RUC</h5>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input id="ruc" name="txtRuc" class="form-control ml-1 mt-3 text-dark " type="text " value="" minlength="11" maxlength="11 " pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]">
                                    </td>
                                </tr>
        ...
        <!-- Modal Eliminar Usuario cliente -->

        <div id="deleteUser" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="${pageContext.request.contextPath}/UsuarioController?btnEnviar=deleteUserCliente" method="post">
                        <div class="modal-header">
                            <h4 class="modal-title">Eliminar usuario cliente</h4>
                            <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
